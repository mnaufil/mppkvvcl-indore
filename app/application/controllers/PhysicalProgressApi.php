    ...
    public function edit_applied_observation_post()
    {
       if (!empty($this->post())) {
            ...
            if ($applied_obs_data) {
                ...
                $created_by_details = $this->pp_model->getUserData($applied_obs_data['createdby']);
                $applied_obs_data['created_by_role'] = $this->pp_model->getUserRole($created_by_details->role_id);
