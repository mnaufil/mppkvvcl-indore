	...
	public function saveMaterialInwardData($import_hdr_id, $worksheet_arr)
	{
		...
		foreach ($worksheet_arr as $key => $value) {
			$data = array(
				...
				'lot_no' => $value[0],
				'circle' => $value[1],
				'material_description' => $value[2],
				'unit' => $value[3],
				'name_of_vendor' => $value[4],
				'di_no' => $value[5],
				'di_date' => $value[6],
				'di_quantity' => $value[7],
				'received_quantity' => $value[8],
				'received_date' => $value[9],
				'is_active' => 1,
				'createdby' => $this->getLoggedInUserID(),
				'createddate' => date('Y-m-d H:i:s')
			);
	...
	public function saveMaterialInwardMICCData($import_hdr_id, $worksheet_arr)
	{
		...
		foreach ($worksheet_arr as $key => $value) {
			$data = array(
				...
				'received_quantity' => $value[8],
				'received_date' => $value[9],
				'sampling_quantity' => $value[10],
				'sampling_seal_date' => $value[11],
				'micc_no' => $value[12],
				'micc_date' => $value[13],
				'billing_status' => $value[14],
				'amount_in_cr_60' => $value[15],
				'amount_in_cr_100' => $value[16],
				'remark' => $value[17],
				'is_active' => 1,
				'createdby' => $this->getLoggedInUserID(),
				'createddate' => date('Y-m-d H:i:s')
	...
	public function saveMaterialInwardReturnData($import_hdr_id, $worksheet_arr)
	{
		...
		foreach ($worksheet_arr as $key => $value) {
			$data = array(
				...
				'received_quantity' => $value[8],
				'received_date' => $value[9],
				'returned_quantity' => $value[10],
				'returned_date' => $value[11],
				'is_active' => 1,
				'createdby' => $this->getLoggedInUserID(),
				'createddate' => date('Y-m-d H:i:s')
			);
