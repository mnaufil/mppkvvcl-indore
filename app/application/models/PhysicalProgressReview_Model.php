...
{	
    ...
    IFNULL(tt_act.tt_activity, 0) AS tt_task,
...
LEFT JOIN(
    SELECT
        A.physical_progress_id AS physical_progress_id,
...
WHERE
    physical_progress.is_draft = 0 AND physical_progress.status_id = 13 AND contract.status_id = 14 AND contract_location.is_active = 1 AND U.user_id = 1
ORDER BY
    physical_progress.status_id
DESC
    ,
