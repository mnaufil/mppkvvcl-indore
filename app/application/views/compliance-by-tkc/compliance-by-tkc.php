...
<html>
	...
	<body class="app sidebar-mini ltr light-mode">
		                              ...
		                              <table class="table table-bordered text-nowrap border-bottom dataTable no-footer" id="basic-datatable" role="grid" aria-describedby="basic-datatable_info">
				            								<thead>
				            									<tr role="row">
				            										...
				            										<th class="wd-10p border-bottom-0 sorting sorting_asc" tabindex="17" aria-controls="basic-datatable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Date of Submitted By TKC: activate to sort column descending" style="width: 95.5156px;">Date of Submitted By TKC</th>
				            									</tr>
				            								</thead>
				            								<tbody>
        ...
        $('input[name="complianceByTKCDate"]').on('apply.daterangepicker', function(ev, picker) {
    		...
    		$('#searchComplianceByTKC').submit(function(event) {
