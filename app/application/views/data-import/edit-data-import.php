                				...
                				<div class="card">
                					<div class="card-body mt-3">
                						...
                						<div class="row">
		                                 ...
		                                 <select class="form-control select2" id="importType" name="importType" disabled>
                                         	<option value="<?php echo $import_details['import_type'] ?>" selected><?php echo $import_details['import_type'] ?></option>
		                                 ...
		                                 <select class="form-control select2" id="importSubType" name="importSubType" disabled>
		                                 	<option value="<?php echo $import_details['sub_type']; ?>" selected><?php echo $import_details['sub_type']; ?></option>
	                                    </select>
             								</div>
             								<!-- Sample Format -->
             								<div class="col-xl-3" id="download-format-div">
             									<!-- <label class="form-label" for="">Sample Format</label> -->
                								<a type="button" href="<?php echo base_url($format_file_path); ?>" class="btn btn-light btn-wave waves-effect waves-light mt-5" id="download-btn" download="<?php echo $format_file_name; ?>"> Download Format 
                						...
                						<div class="row" id="file-upload-div">
                							<!-- File Upload -->
				            			...
				            			<div class="row mt-3 mb-3" id="file-upload-process-result-div">
				            				<div class="accordion" id="accordionExample">
				            					<!-- Valid Records -->
				            					<div class="accordion-item">
				            						<h2 class="accordion-header" id="headingValid">
				            							<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#validRecords" aria-expanded="false" aria-controls="validRecords"> Valid Records (<?php echo count($valid_records); ?>) </button>
				            						</h2>
				            					...
				            					<div class="accordion-item">
				            						<h2 class="accordion-header" id="headingInvalid">
				            							<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#invalidRecords" aria-expanded="false" aria-controls="invalidRecords"> Invalid Records (<?php echo count($invalid_records); ?>) </button>
				            						</h2>
				            							...
				            							<div class="accordion-body">
				            								<div class="table-responsive">
				            									<table class="table text-nowrap" id="table-invalid-records">
				            										...
				            										<tbody class="table-group-divider">
				            											<?php foreach ($invalid_records as $key => $value) { ?>
				            											<tr>
      		...
      		if ($.inArray(file_ext, ['xls', 'xlsx']) == -1) {
               ...
               return false;
      			...
      			let formData = new FormData();
        			...
        			let import_hdr_id = <?php echo $import_hdr_id ?>;
    				...
    				$('#btn-process-file').prop('disabled', true);
