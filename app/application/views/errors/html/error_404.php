...
<head>
    ...
    <!-- TITLE -->
    <title>MPPKVVCL - 404 Pabe Not Found</title>
                ...
                <div class="container text-center">
                    <div class="error-template">
                        ...
                        <div class="text-center">
                            <a class="btn btn-secondary mt-5 mb-5" href="<?php echo base_url('dashboard');?>"> <i class="fa fa-long-arrow-left"></i> Back to Dashboard </a>
                        </div>
                    </div>
                </div>
            </div>
