                        ...
                        <div class="d-flex order-lg-2">
                            ...
                            <div class="tot-amount-hed" style="margin-right: 10px;">
                                ...
                                <div class="row contract-value">
                                    ...
                                    <span style="text-align: right;">Total Financial Value of the Work<br><h6 class="mb-0 text-green fw-semibold"><b><?php echo isset($totalData[1]['Total_financial_physical_progress']) ? $totalData[1]['Total_financial_physical_progress'] : 0; ?></b>(<?php echo isset($totalData[1]['Total_financial_physical_progress_per']) ? $totalData[1]['Total_financial_physical_progress_per'].'%' : ''; ?>)</h6></span>
                                </div>
                                <div class="row financial-value">
                                    <span style="text-align: right;">Financial Value - WIP <br><h6 class="mb-0 text-green fw-semibold"><b><?php echo isset($totalData[1]['wip_financial_physical_progress']) ? $totalData[1]['wip_financial_physical_progress'] : 0;?></b>(<?php echo isset($totalData[1]['wip_financial_physical_progress_per']) ? $totalData[1]['wip_financial_physical_progress_per'].'%' : ''; ?>)</h6></span>
                                    <span style="text-align: right;">Financial Value - Completed <br><h6 class="mb-0 text-green fw-semibold"><b><?php echo isset($totalData[1]['completed_financial_physical_progress']) ? $totalData[1]['completed_financial_physical_progress'] : 0;?></b>(<?php echo isset($totalData[1]['completed_financial_physical_progress_per']) ? $totalData[1]['completed_financial_physical_progress_per'].'%' : ''; ?>)</h6></span>
                                </div>
                            </div>
                         </div> 
