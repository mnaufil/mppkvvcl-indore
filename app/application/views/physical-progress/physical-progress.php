...
<html  lang="en" dir="ltr">
  ...
  <body class="app sidebar-mini ltr light-mode">
                        ...
                        <div class="accordion-item">
                          ...
                          <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample" style="">
                            <div class="accordion-body p-1">
                              <form name="searchPhysicalProgressSheet" id="searchPhysicalProgressSheet" method="post" action="<?php echo base_url('search-physical-progress-sheet'); ?>">
                                <!-- Row1 -->
                                <div class="row">
                                  <!-- Contractor (TKC) -->
                                  <div class="col-md-4">
    ...
    $('#searchPhysicalProgressSheet').on('submit', function(event) {
    ...
    $('.clear-search-filters').on('click', function(event) {
      ...
      let search_form = $('#searchPhysicalProgressSheet')[0];
