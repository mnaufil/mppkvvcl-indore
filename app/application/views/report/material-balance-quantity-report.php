	          							...
	          							<div class="card-body">
	          								...
	          								<div class="form-row mt-2 mb-2">
	          									<div class="col-xl-4">
	          										...
	          										<p class="report-desc">Material Balance Quantity Report</p>
	          									</div>
	          								</div>

	          								<form id="generateMaterialBalanceQuantityReport" name="generateMaterialBalanceQuantityReport" method="POST" action="<?php echo base_url('generate-material-balance-quantity-report'); ?>">
	          									<!-- Row1 -->
	          									<div class="form-row">
	          										<!-- Lot No -->
	          									...
	          									<a class="btn btn-light mb-3 mt-3" href="<?php echo base_url('material-balance-quantity-report')?>">Clear</a>
	          												...
	          												<table class="table border table-bordered text-nowrap text-md-nowrap table-sm mb-0">
	          													<thead>
	          														<tr>
	          															...
	          															<th scope="col">Revised Quantity</th>
	          													...
	          													<tbody>
	          														...
	          														<tr>
	          															<td><?php echo $value['equipment_material_name']; ?></td>
	          															<td><?php echo $value['unit']; ?></td>
	          															<td><?php echo $value['revised_quantity']; ?></td>
	          															<td><?php echo $value['received_quatity']; ?></td>
	          															<td><?php echo $value['Balance_Quantity']; ?></td>
