	          							...
	          							<div class="card-body">
	          								...
	          								<div class="form-row mt-2 mb-2">
	          									<div class="col-xl-4">
	          										...
	          										<p class="report-desc">Material Inward MICC Details Report</p>
	          									</div>
	          								</div>

	          								<!-- Form -->
	          								<form id="generateMaterialInwardMICCDetailsReport" name="generateMaterialInwardMICCDetailsReport" method="POST" action="<?php echo base_url('generate-material-inward-micc-details-report'); ?>">
	          									<!-- Row1 -->
	          									<div class="form-row">
	          										<!-- Lot No -->
	          									...
	          									<div class="form-row">
	          										<!-- DI No -->
	          										<div class="col-xl-4 mb-3">
	          											<label for="di_no" class="form-label">DI No.<span class="text-red">*</span></label>
	          											<?php $di_no_value = (isset($di_no)) ? $di_no : ''; ?>
	          											<input type="text" class="form-control" id="di_no" name="di_no" value="<?php echo $di_no_value; ?>">
	          										</div>
	          									...
	          									<a class="btn btn-light mb-3 mt-3" href="<?php echo base_url('material-inward-micc-details-report')?>">Clear</a>
	          												...
	          												<table class="table border table-bordered text-nowrap text-md-nowrap table-sm mb-0">
	          													<thead>
	          														<tr>
	          															...
	          															<th scope="col">MICC No</th>
	          															<th scope="col">MICC Date</th>
	          															<th scope="col">Billing Status</th>
	          															<th scope="col">Amount in Cr.(60%)</th>
	          															<th scope="col">Amount in Cr.(100%)</th>
	          													...
	          													<tbody>
	          														...
	          														<tr>
	          															...
	          															<td><?php echo $value['micc_no']; ?></td>
	          															<td><?php echo $value['micc_date']; ?></td>
	          															<td><?php echo $value['billing_status']; ?></td>
	          															<td><?php echo $value['amount_in_cr_60']; ?></td>
	          															<td><?php echo $value['amount_in_cr_100']; ?></td>
		...
		<script src="<?php echo base_url('assets/plugins/bootstrap5-typehead/autocomplete.js'); ?>"></script>
	 	...
	 	<!-- <script src="<?php echo base_url('assets/plugins/datatable/js/buttons.php5.min.js'); ?>"></script> -->
	   	...
	   	<script type="text/javascript">
        	...
        	$('#generateMaterialInwardMICCDetailsReport').submit(function(event) {
        		...
        		let di_no = $('input[name="di_no"]').val();

        		let material_received_date = $('input[name="matrerialReceivedDate"]').val();

        		if (package_no == null && circle == null && status == null && di_no == '' && material_received_date == '') {
