	          							...
	          							<div class="card-body">
	          								...
	          								<div class="form-row mt-2 mb-2">
	          									<div class="col-xl-4">
	          										...
	          										<p class="report-desc">Material Inward Report</p>
	          									</div>
	          								</div>

	          								<!-- Form -->
	          								<form id="generateMaterialInwardReport" name="generateMaterialInwardReport" method="POST" action="<?php echo base_url('generate-material-inward-report'); ?>">
	          									<!-- Row1 -->
	          									<div class="form-row">
	          										<!-- Lot No -->
	          									...
	          									<a class="btn btn-light mb-3 mt-3" href="<?php echo base_url('material-inward-report')?>">Clear</a>
		...
		<!-- Perfect SCROLLBAR JS-->
 		...
 		<!-- <script src="<?php echo base_url('assets/plugins/datatable/js/buttons.php5.min.js'); ?>"></script> -->
	   	...
	   	<script type="text/javascript">
	   		...
	   		$('#generateMaterialInwardReport').submit(function(event) {
