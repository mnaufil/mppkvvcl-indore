	          							...
	          							<div class="card-body">
	          								...
	          								<div class="form-row mt-2 mb-2">
	          									<div class="col-xl-4">
	          										...
	          										<p class="report-desc">Material return back to supplier</p>
	          									</div>
	          								</div>

	          								<!-- Form -->
	          								<form id="generateMaterialInwardReturnReport" name="generateMaterialInwardReturnReport" method="POST" action="<?php echo base_url('generate-material-inward-return-report'); ?>">
	          									<!-- Row1 -->
	          									<div class="form-row">
	          										<!-- Lot No -->
	          										...
	          										<!-- Material Return Daterange -->
	          										<div class="col-xl-4 mb-3">
	          											<label class="form-label" for="matrerialReturnDate">Material Return Date<span class="text-red">*</span></label>
	          											<div class="input-group">
	          												<div class="input-group-text" id="material-return-date">
	          													<i class="fa fa-calendar tx-16 lh-0 op-6"></i>
	          												</div>
	          												<?php $date_value = (isset($material_return_date)) ? $material_return_date : ''; ?>
	          												<input class="form-control" type="text" id="matrerialReturnDate" name="matrerialReturnDate" value="<?php echo $date_value; ?>">
	          											</div>
	          										</div>
	          									</div>
	          									...
	          									<a class="btn btn-light mb-3 mt-3" href="<?php echo base_url('material-inward-return-report')?>">Clear</a>
	          												...
	          												<table class="table border table-bordered text-nowrap text-md-nowrap table-sm mb-0">
	          													...
	          													<tbody>
	          														...
	          														<tr>
	          															...
	          															<td><?php echo $value['returned_quantity']; ?></td>
	          														</tr>	
	          														<?php } ?>
	          													</tbody>
	          												</table>
