	          							...
	          							<div class="card-body">
	          								...
	          								<div class="form-row mt-2 mb-2">
	          									<div class="col-xl-4">
	          										...
	          										<p class="report-desc">Material Stock Report</p>
	          									</div>
	          								</div>

	          								<form id="generateMaterialStockReport" name="generateMaterialStockReport" method="POST" action="<?php echo base_url('generate-material-stock-report') ?>">
	          									<!-- Row1 -->
	          									<div class="form-row">
	          										<!-- Lot No -->
	          										...
	          										<!-- DateRange -->
	          										<div class="col-xl-4 mb-3">
	          											<label class="form-label" for="dateRange">Date Range<span class="text-red">*</span></label>
	          											<div class="input-group">
	          												<div class="input-group-text" id="date-range">
	          													<i class="fa fa-calendar tx-16 lh-0 op-6"></i>
	          												</div>
	          												<?php $date_value = (isset($date_range)) ? $date_range : ''; ?>
	          												<input class="form-control" type="text" id="dateRange" name="dateRange" value="<?php echo $date_value; ?>">
	          											</div>
	          										</div>
	          									</div>
	          									...
	          									<a class="btn btn-light mb-3 mt-3" href="<?php echo base_url('material-stock-report')?>">Clear</a>
	          												...
	          												<table class="table border table-bordered text-nowrap text-md-nowrap table-sm mb-0">
	          													...
	          													<tbody>
	          														...
	          														<tr>
	          															...
	          															<td><?php echo $value['closing_quantity']; ?></td>
	          														</tr>	
	          														<?php } ?>
	          													</tbody>
	          												</table>
		...
		<script src="<?php echo base_url('assets/plugins/bootstrap5-typehead/autocomplete.js'); ?>"></script>
	  	...
	  	<script src="<?php echo base_url('assets/plugins/multipleselect/multi-select.js'); ?>"></script> 
	   	...
	   	<script type="text/javascript">
	   		...
	   		$('#generateMaterialStockReport').submit(function(event) {
	   			...
	   			if (package_no == null && circle == null && date_range == '') {
