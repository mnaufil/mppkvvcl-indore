	...
	<body class="app sidebar-mini ltr light-mode">
	          							...
	          							<div class="card-body">
	          								...
	          								<div class="form-row mt-2 mb-2">
	          									<div class="col-xl-4">
	          										...
	          										<p class="report-desc"><?php echo $title; ?></p>
	          									</div>
	          								</div>

	          								<form id="generateMaterialDIIssuedButMaterialNotReceivedReport" name="generateMaterialDIIssuedButMaterialNotReceivedReport" method="POST" action="<?php echo base_url('generate-material-di-issued-but-material-not-received-report') ?>">
	          									<!-- Row1 -->
	          									<div class="form-row">
	          										<!-- Lot No -->
	          										...
	          										<!-- DI Received DateRange -->
	          										<div class="col-xl-4 mb-3">
	          											<label class="form-label" for="diReceivedDateRange">DI Received Date Range<!-- <span class="text-red">*</span> --></label>
	          											<div class="input-group">
	          												<div class="input-group-text" id="di-received-date-range">
	          													<i class="fa fa-calendar tx-16 lh-0 op-6"></i>
	          												</div>
	          												<?php $date_value = (isset($date_range)) ? $date_range : ''; ?>
	          												<input class="form-control" type="text" id="diReceivedDateRange" name="diReceivedDateRange" value="<?php echo $date_value; ?>">
	          											</div>
	          										</div>
	          									</div>
	          									...
	          									<a class="btn btn-light mb-3 mt-3" href="<?php echo base_url('material_di_issued_but_material_not_received_report')?>">Clear</a>
		...
		<script src="<?php echo base_url('assets/plugins/bootstrap5-typehead/autocomplete.js'); ?>"></script>
	   	...
	   	<script type="text/javascript">
	   		$('input[name="diReceivedDateRange"]').daterangepicker({
	   		...
	   		$('input[name="diReceivedDateRange"]').on('apply.daterangepicker', function(ev, picker) {
            	$(this).val(picker.startDate.format('DD-MM-YYYY') +' - '+ picker.endDate.format('DD-MM-YYYY'));
        	});

        	$('#generateMaterialDIIssuedButMaterialNotReceivedReport').submit(function(event) {
