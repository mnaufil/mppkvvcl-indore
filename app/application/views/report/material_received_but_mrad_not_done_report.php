	...
	<body class="app sidebar-mini ltr light-mode">
	          					...
	          					<div class="col-lg-12">
	          						<div class="card">
	          							<div class="card-body">
	          								...
	          								<form id="generateMaterialReceivedButMRADNotDoneReport" name="generateMaterialReceivedButMRADNotDoneReport" method="POST" action="<?php echo base_url('generate-material-received-but-mrad-not-done-report'); ?>">
	          									<!-- Row1 -->
	          									<div class="form-row">
	          										<!-- Lot No -->
	          										...
	          										<div class="col-xl-4 mb-3">
	          											<label class="form-label" for="materialReceivedDateRange">Material Received Date Range<!-- <span class="text-red">*</span> --></label>
	          											<div class="input-group">
	          												<div class="input-group-text" id="material-received-date-range">
	          													<i class="fa fa-calendar tx-16 lh-0 op-6"></i>
	          												</div>
	          												<?php $date_value = (isset($date_range)) ? $date_range : ''; ?>
	          												<input class="form-control" type="text" id="materialReceivedDateRange" name="materialReceivedDateRange" value="<?php echo $date_value; ?>">
	          											</div>
	          										</div>
	          									</div>
	          									...
	          									<a class="btn btn-light mb-3 mt-3" href="<?php echo base_url('material_received_but_mrad_not_done_report')?>">Clear</a>
		...
		<script src="<?php echo base_url('assets/plugins/bootstrap5-typehead/autocomplete.js'); ?>"></script>
	   	...
	   	<script type="text/javascript">
	   		$('input[name="materialReceivedDateRange"]').daterangepicker({
	   		...
	   		$('input[name="materialReceivedDateRange"]').on('apply.daterangepicker', function(ev, picker) {
