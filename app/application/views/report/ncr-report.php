			                					...
			                					<div class="table-responsive mb-3 mt-3" style="max-height: 500px;overflow: auto;" id="package-wise-table">
			                						<table class="table border table-bordered text-nowrap text-md-nowrap table-sm mb-0">
														...
														<?php foreach($reportData as $report) { ?>
			                								<tr>
			                									<td class="table-td-center"><?php echo $report->package_no;?></td>
			                									...
			                									<td class="table-td-center"><?php echo $report->rejected_count;?></td>
			                									<td class="table-td-center"><?php echo $report->oldest_ncr;?></td>
			                								</tr>
			                							<?php } ?>	
														<?php } ?>	
			                							</tbody>
			                						...
			                						<table class="table border table-bordered text-nowrap text-md-nowrap table-sm mb-0">
														...
														<?php foreach($reportData as $report) { ?>
			                								<tr>
			                									...
			                									<td><?php echo $report->contractor_name;?></td>
																	<td><?php echo $report->circle_name;?></td>
			                									<td class="table-td-center"><?php echo $report->feeder_id;?></td>
