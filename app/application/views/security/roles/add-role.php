	...
	<body class="app sidebar-mini ltr light-mode">
	            	...
	            	<div class="side-app">
	            		...
	            		<div class="main-container container-fluid">
	            			...
	            			<div class="row row-sm">
	            				<div class="col-lg-12">
	            					<form id="saveRole" name="saveRole" method="post" action="<?php echo base_url('save-role'); ?>">
	            						<div class="card">
	                                    	...
	                                    	<div class="card-body">
	                                    		<div class="form-row">
	                                    			...
	                                    			<div class="col-xl-4 mb-3">
	                                    				<label class="form-label" for="roleName">Role Name
	                                       				...
	                                       				<input type="text" class="form-control" id="roleName" name="roleName" onkeyup="changeFormStatus()" onpaste="changeFormStatus()" value="">
	                                    			</div>
	                                    			<!-- Role Description -->
	                                    			<div class="col-xl-4 mb-3">
	                                    				<label class="form-label" for="roleDesc">Role Description
	                                       				...
	                                       				<input type="text" class="form-control" id="roleDesc" name="roleDesc" onkeyup="changeFormStatus()" onpaste="changeFormStatus()" value="">
	                                    			</div>
	                                    		</div>
	                                    						...
	                                    						<tbody>
	                                    							...
	                                    							<tr data-row-id="<?php echo $i; ?>">
	                                    								...
	                                    								<td class="text-center">
																			...
																			<input type="checkbox" name="<?php echo $check_view; ?>" value="Yes" onchange="checkFullAccess(this)" <?php echo $disabled; ?>>
	                                    								</td>
	                                    								<!-- Add -->
	                                    								<td class="text-center">
	                                    									<?php if ($val == 'Physical Progress' || $val == 'Financial Progress') {
																			...
																			<input type="checkbox" name="<?php echo $check_add; ?>" value="Yes" onchange="checkFullAccess(this)" <?php echo $disabled; ?>>
	                                    								</td>
	                                    								<!-- Update -->
	                                    								<td class="text-center">
	                                    									<?php if ($val == 'Physical Progress' || $val == 'Financial Progress') {
																		    ...
																		    <input type="checkbox" name="<?php echo $check_update; ?>" value="Yes" onchange="checkFullAccess(this)" <?php echo $disabled; ?>>
	                                    								</td>
	                                    								<!-- Delete -->
	                                    								<td class="text-center">
	                                    									<?php if ($val == 'Physical Progress' || $val == 'Financial Progress') {
																		    ...
																		    <input type="checkbox" name="<?php echo $check_delete; ?>" value="Yes" onchange="checkFullAccess(this)" <?php echo $disabled; ?>>
	                                    								</td>
	                                    								<!-- Download -->
	                                    								<td class="text-center">
	                                    									<?php if ($val == 'Physical Progress' || $val == 'Financial Progress') {
																		    ...
																		    <input type="checkbox" name="<?php echo $check_download; ?>" value="Yes" onchange="checkFullAccess(this)" <?php echo $disabled; ?>>
	                                    								</td>
	                                    							</tr>
	                                    							<?php 	}
	                                    								 	  } else {
																...
																<tbody>
																	...
																	<tr>
																		...
																		<td class="text-center">
																			...
																			?>
																		    <input type="checkbox" name="<?php echo $report_view; ?>" value="Yes" onchange="checkReportFullAccess(this)">
																		</td>
																		<!-- Download -->
																		<td class="text-center">
																			<?php if (str_contains($value['name'], 'Report')) {
																			...
																			?>
																		    <input type="checkbox" name="<?php echo $report_download; ?>" value="Yes" onchange="checkReportFullAccess(this)">
																		</td>
																	</tr>	
																	<?php } ?>
																</tbody>
	                                    		...
	                                    		<button class="btn btn-success mb-3 mt-3" type="submit">Submit</button>
	    ...
	    <script type="text/javascript">
	    	...
	    	function setReportFullAccess(checkbox) {
	    		...
	    		if ($(checkbox).is(':checked') == true) {
	    			if ($(report_module_fullaccess).is(':checked')) {
	    	...
	    	$('#saveRole').on('submit', function(event) {
	    		var inputs = $('#saveRole').find(':input[type="text"]');
	    		...
	    		var checkboxes = $('#saveRole').find(':input[type="checkbox"]:checked');
