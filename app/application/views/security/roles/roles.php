    ...
    <body class="app sidebar-mini ltr light-mode">
                            ...
                            <div class="page-header">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mt-2 mb-3">
                                        <a  href="<?php echo base_url('add-role'); ?>" class="btn btn-success btn-add">Add</a>
                                    </div>
                                </div>
                            </div>
                            <!-- PAGE-HEADER END -->
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body p-2">
                                            ...
                                            <div class="accordion" id="accordionExample">
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="headingOne">
                                                        ...
                                                        ?>
                                                        <button class="accordion-button collapsed active prog-btn <?php echo $accordion_btn_class; ?>" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne" <?php echo $accordion_btn_style; ?>>Search Role</button>
                                                    </h2>
                                                    ...
                                                    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample" style="">
                                                        <div class="accordion-body p-1">
                                                            <form name="searchRole" id="searchRole" method="post" action="<?php echo base_url('search-role'); ?>">
                                                                <!-- Row1 -->
                                                                <div class="row">
                                                                    <!-- Role -->
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label class="form-label m-0" for="roleName">Role Name</label>
                                                                            <input class="form-control" type="text" name="roleName" id="roleName" value="<?php echo (isset($filters) && $filters['roleName']['value'] != '') ? $filters['roleName']['value'] : ''; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <!-- Status -->
                                                                    <div class="col-md-2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select multiple="multiple" class="filter-multi" name="status[]" id="status">
                                                                                ...
                                                                                <option value="1" <?php echo (!empty($selected_status) && in_array(1, $selected_status)) ? 'selected' : ''; ?>>Active</option>
                                                                                <option value="0" <?php echo (!empty($selected_status) && in_array(0, $selected_status)) ? 'selected' : ''; ?>>Inactive</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <!-- Delete Alert -->
                                            <div class="row war-pop" id="role-delete-alert" hidden>
                                                <div class="col-xl-3 col-sm-6 war-pop-1">
                                                   <div class="card border p-0 pb-3">
                                                        ...
                                                        <div class="card-body text-center">
                                                            ...
                                                            <p class="card-text notification-text">Are you sure you want to delete Role?</p>
                                                        </div>
                                                        <div class="card-footer text-center border-0 pt-0">
                                                            <div class="row">
                                                                <div class="text-center">
                                                                    <a href="javascript:void(0)" class="btn btn-danger notification-delete" data-role-id="" onclick="deleteRole(this)">Delete</a>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td name="bstable-actions">
                                                                <div class="btn-list">
                                                                    <a href="<?php echo base_url('edit-role/'.$value['role_id']); ?>" type="button" class="btn btn-sm" id="bEdit">
                                                                        <span class="fe fe-edit fa-lg action-btn-table"> </span>
                                                                    </a>
                                                                    &nbsp;&nbsp;
                                                                    <button type="button" class="btn btn-sm deleteRole" data-role-id="<?php echo $value['role_id']; ?>">
        ...
        <script type="text/javascript">
            ...
            $('.deleteRole').click(function() {
                ...
                let role_name = $(this).closest('td[name="bstable-actions"]').next('td').text();

                let alert_text = 'Are you sure you want to delete '+ role_name +' Role ?';

                $('#role-delete-alert').find('.notification-text').text(alert_text);
                $('#role-delete-alert').find('.notification-delete').attr('data-role-id', role_id);
                $('#role-delete-alert').removeAttr('hidden');
            });

            function deleteRole(delete_btn) {
                let role_id = $(delete_btn).data('role-id');

                // Ajax call to delete the role
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url('delete-role') ?>',
                    dataType: 'json',
            ...
            function closeNotificationAlert(close_btn) {
                $('#role-delete-alert').find('.notification-text').text('');
                $('#role-delete-alert').find('.notification-delete').attr('data-role-id', '');
                $('#role-delete-alert').attr('hidden', true);
            }

            //Check if there's any change in the search form before submitting
            $('#searchRole').submit(function(event) {
