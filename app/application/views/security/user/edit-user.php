                        ...
                        <div class="col-lg-12 col-md-12">
                           <div class="card">
                              ...
                              <div class="card-body mt-3">
                                 <form id="updateUser" action="<?php echo base_url('update-users')?>" method="POST">
                                    <div class="form-row">
                                       ...
                                       <div class="col-xl-4 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="name" value="<?php echo $singleUser->username?>" required name="name" onblur="charlimit('name', 100)">
                                          <div class="valid-feedback">Looks good!</div>
                                       </div>
                                       <!-- Email -->
                                       <div class="col-xl-4 mb-3">
                                          <label for="validationCustom02" class="form-label">Email Address  <span class="text-red">*</span></label>
                                          <input type="text" class="form-control" id="email" value="<?php echo $singleUser->email?>" required name="email" onblur="charlimit('email', 100)" onfocusout ="ValidateEmail(this.value)">
                                          <div class="valid-feedback">Looks good!</div>
                                       </div>
                                       <!-- Contact No -->
                                       <div class="col-xl-4 mb-3">
                                          <label for="validationCustom02" class="form-label">Contact No  <span class="text-red">*</span></label>
                                          <input type="number" class="form-control" id="contact" value="<?php echo $singleUser->contact_no?>" required name="contact" onblur="charlimit('contact', 10)" onkeyup="intOnly('contact',this.value);">
                                          <div class="valid-feedback">Looks good!</div>
                                       </div>
                                       <!-- Designation -->
                                       <div class="col-xl-4 mb-3">
                                          <label for="validationCustom02" class="form-label">Designation  <span class="text-red">*</span></label>
                                          <input type="text" class="form-control" id="designation" value="<?php echo $singleUser->designation?>" required name="designation"  onblur="charlimit('designation', 100)">
                                          <div class="valid-feedback">Looks good!</div>
                                       </div>
                                       <!-- Location -->
                                       <div class="col-xl-4 mb-3">
                                          <label for="validationCustom02" class="form-label">Location<span class="text-red">*</span></label>
                                          <input type="text" class="form-control" id="location" value="<?php echo $singleUser->location?>" required name="location" onblur="charlimit('location', 100)">
                                          <div class="valid-feedback">Looks good!</div>
                                       </div>
                                       <!-- Reporting Manager -->
                                       <div class="col-xl-4 mb-3">
                                       ...
                                       <?php $package_div_hidden = ($singleUser->user_role != 'TKC') ? 'hidden' : ''; ?>
                                       <div class="col-xl-4 mb-3" id="package_access_div" <?php echo $package_div_hidden; ?>>
                                          <div class="form-group">
                                             ...
                                             <select multiple="multiple" class="filter-multi" name="package_access[]" id="package_access">
                                                <?php $granted_packages = explode(',', $singleUser->package_access); ?>
                                                <?php foreach ($packages as $key => $value) { ?>
                                                <?php    $package_select = (in_array($value['package_group_no'], $granted_packages)) ? 'selected' : ''; ?>
                                       ...
                                       <!-- Site Grant Access -->
                                       <?php $site_div_hidden = ($singleUser->user_role == 'TKC') ? 'hidden' : ''; ?>
                                       <div class="col-xl-12 mb-3" id="site_access_div" <?php echo $site_div_hidden; ?>>
                                         ...
                                         <input type="hidden" name="full_site_access" value="<?php echo $singleUser->is_full_data_access; ?>">
                                       </div>
                                    </div>
