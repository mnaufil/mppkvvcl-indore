...
<body class="app sidebar-mini ltr light-mode">
                        ...
                        <div class="page-header">
                            ...
                            <div class="row">
                                <div class="col-md-12 mt-2 mb-3">
                                    <a  href="<?php echo base_url('add-circle'); ?>" class="btn btn-success btn-add">Add</a>
                                </div>
                            </div>
                        </div>
                        <!-- Page-Header Ends -->
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body p-2">
                                        ...
                                        <div class="accordion" id="accordionExample">
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="headingOne">
                                                    ...
                                                    ?>
                                                    <button class="accordion-button collapsed active prog-btn <?php echo $accordion_btn_class; ?>" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne" <?php echo $accordion_btn_style; ?>>Search Circle</button>
                                                </h2>
                                                ...
                                                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample" style="">
                                                    <div class="accordion-body p-1">
                                                        <form name="searchCircle" id="searchCircle" method="post" action="<?php echo base_url('search-circle'); ?>">
                                                            <!-- Row1 -->
                                                            <div class="row">
                                                                <!-- Region -->
                                                                <div class="col-md-2">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" name="circle" id="circle" value="<?php echo (isset($filter_data) && !empty($filter_data['circle']['value'])) ? $filter_data['circle']['value'] : ''; ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!-- Row2 -->
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3 mt-3">
                                                                    <button type="submit" class="btn btn-primary mt-1 mb-1 search-circle-btn">Search</button>
                                        ...
                                        <!-- Delete Alert -->
                                        <div class="row war-pop" id="circle-delete-alert" hidden>
                                            <div class="col-xl-3 col-sm-6 war-pop-1">
                                               <div class="card border p-0 pb-3">
                                                    ...
                                                    <div class="card-body text-center">
                                                        ...
                                                        <p class="card-text notification-text">Are you sure you want to delete Circle?</p>
                                                    </div>
                                                    <div class="card-footer text-center border-0 pt-0">
                                                        <div class="row">
                                                            <div class="text-center">
                                                                <a href="javascript:void(0)" class="btn btn-danger notification-delete" data-circle-id="" onclick="deleteCircle(this)">Delete</a>
                                       ...
                                       <div class="table-responsive mt-3">
                                           <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="<?php echo base_url('edit-circle/'.$value['circle_id']); ?>" class="btn btn-sm">
                                                                <span class="fe fe-edit fa-lg action-btn-table"></span>
                                                            </a>&nbsp;&nbsp;
                                                            <button type="button" class="btn btn-sm deleteCircle" data-circle-id="<?php echo $value['circle_id']; ?>">
                                                                <span class="fe fe-trash-2 fa-lg action-btn-table"></span>
                                                            </button>
                                                        </td>
                                                        <td class="circle-name"><?php echo $value['circle_name']; ?></td>
    ...
    <script type="text/javascript">
        ...
        $('.deleteCircle').click(function() {
            let circle_id = $(this).data('circle-id');
            let circle_name = $(this).parent().next('.circle-name').text();

            let alert_text = 'Are you sure you want to delete '+ circle_name +' Circle ?';

            $('#circle-delete-alert').find('.notification-text').text(alert_text);
            $('#circle-delete-alert').find('.notification-delete').attr('data-circle-id', circle_id);
            $('#circle-delete-alert').removeAttr('hidden');
        });

        function deleteCircle(delete_btn) {
            let circle_id = $(delete_btn).data('circle-id');

            // Ajax call to delete the circle
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url('delete-circle') ?>',
                dataType: 'json',
                data: {circle_id:circle_id},
                success: function(response) {
                    console.log(response);

                    $('#circle-delete-alert').find('.notification-text').text('');
                    $('#circle-delete-alert').find('.notification-delete').attr('data-region-id', '');

                    $('#circle-delete-alert').attr('hidden', true);

                    $('.toast-body').text('Circle and its corresponding divisions deleted successfully');
                    $('.toast').toast('show');
        ...
        $('#searchCircle').submit(function(event) {
            let select = $(this).find('select.form-control');
            let selected_data = $(select).select2('data');
        ...
        $('.clear-search-filters').on('click', function(event) {
            ...
            let search_form = $('#searchCircle')[0];
