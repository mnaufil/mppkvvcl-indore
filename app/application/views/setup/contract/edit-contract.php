	                     	...
	                     	<div class="card">
	                        	...
	                        	<form id="addContract"  action="<?php echo base_url('update-contract-management')?>" method="POST">
	                        		<div class="card-body">
	                        			...
	                        			<!-- Row7 -->
                     					<div class="form-row">
                     						<!-- Quantity (No.of feeder/Sub Stations) -->
                     						<div class="col-xl-4">
	                        			...
	                        			<div class="form-row">
	                        				<div class="col-lg-12">
	                        					<!-- Region and Circle Wise Breakup Table -->
	                        			...
	                        			<div class="form-row">
                     						<div class="col-lg-12">
                     							<!-- <input type="hidden" name="milestonehiddentable" id="milestonehiddentable" /> -->
                     							<!-- Bank Guarantee Details (BG) Table -->
	                        					<div class="table-responsive" id="milestone_table">
															<table class="table table-bordered border text-nowrap mb-0" id="new-edit-bank-details">
																...
																<tbody>
																	<?php if(!empty($contractbanksdetails)) { ?>
																	<?php foreach($contractbanksdetails as $bank) { ?>
																	<tr>
            		...
            		<div class="modal-content">
            			<form id="boqform" method="POST">
	            			...
	            			<div class="modal-body">
	            				...
	            				<div class="panel panel-primary" id="boqtoadd"></div>
	            			</div>
