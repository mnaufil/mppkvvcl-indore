	                        				...
	                        				<div class="card-body">
	                        					...
	                        					<div class="form-row">
	                        						...
	                        						<div class="col-xl-6 mb-3">
	                        							...
	                        							<input class="form-control" type="text" id="nameOfContractor" name="nameOfContractor" required value="<?php echo $contractdetails->contractor_name;?>" onblur="charlimit('nameOfContractor', 200)" readonly>
	                        						...
	                        						<div class="col-xl-3 mb-3">
	                        							...
	                        							<input class="form-control" type="text" id="tenderAwardNo" required name="tenderAwardNo" value="<?php echo $contractdetails->tender_award_no;?>" onblur="charlimit('tenderAwardNo', 20)" readonly>
	                        						</div>
	                        						...
	                        						<div class="col-xl-3 mb-3">
	                        							...
	                        							<div class="input-group">
	                                                        ...
	                                                        <input type="text" class="form-control" value="<?php echo date('d-m-Y', strtotime($contractdetails->tender_award_date));?>" required readonly />
	                                                    </div>
	                        					...
	                        					<div class="form-row">
	                        						<div class="col-xl-3 mb-3">
	                        							...
	                        							<input class="form-control" type="text" name="packageNo" id="packageNo" required value="<?php echo $contractdetails->package_no;?>" onblur="charlimit('packageNo', 20)" readonly>
	                        						</div>
	                        						<div class="col-xl-3 mb-3">
	                        							<label class="form-label" for="typeOfWork">Type Of Work
	                        								<span class="text-red">*</span>
	                        							</label>
	                        							<select class="form-control select2" id="typeOfWork" required name="typeOfWork" disabled>
	                        								<option value="select" disabled>Select Type Of Work</option>
	                        								<?php foreach($worktypes as $worktype) { ?>
															<option value="<?php echo $worktype->typeofwork_id;?>" <?php if($contractdetails->typeofwork_id==$worktype->typeofwork_id) { ?> selected <?php } ?>><?php echo $worktype->name;?></option>
															<?php } ?>
	                        							</select>
	                        						</div>
	                        						<div class="col-xl-3 mb-3">
	                        							...
	                        							<div class="input-group">
	                        								...
	                        								<input class="form-control" type="text"  value="<?php echo date('d-m-Y', strtotime($contractdetails->effective_date));?>" required onchange="checkDate('effectiveDate', this.value);" readonly>
	                        							</div>
	                        						...
	                        						<div class="col-xl-3 mb-3">
	                        							...
	                        							<div class="input-group">
	                        								...
	                        								<input class="form-control" type="text"  value="<?php echo date('d-m-Y', strtotime($contractdetails->completion_date));?>" required onchange="checkDate('completionDate', this.value);" readonly>
	                        							</div>
	                        					...
	                        					<div class="form-row">
	                        						<div class="col-xl-3 mb-3">
	                        							...
	                        							<input class="form-control" type="text" id="eTenderNo" name="eTenderNo" required value="<?php echo $contractdetails->etender_no;?>" onblur="charlimit('eTenderNo', 20)" readonly>
	                        						</div>
	                        						<div class="col-xl-3 mb-3">
	                        							...
	                        							<div class="input-group">
                        									...
                        									<input class="form-control" type="text" value="<?php echo date('d-m-Y', strtotime($contractdetails->bid_opening_date));?>" readonly>
	                        							</div>
	                        						...
	                        						<div class="col-xl-3 mb-3">
	                        							...
	                        							<div class="input-group">
	                        								...
	                        								<input class="form-control" type="text"  value="<?php echo date('d-m-Y', strtotime($contractdetails->price_bid_opening_date));?>" readonly>
	                        							</div>
	                        					...
	                        					<div class="form-row">
	                        						<div class="col-xl-3 mb-3">
	                        							...
	                        							<input class="form-control" type="number" name="estimatedCostWithoutGST" id="estimatedCostWithoutGST" readonly value="<?php echo $contractdetails->estimated_cost_without_gst;?>" onblur="charlimit('estimatedCostWithoutGST', 12);" onkeyup="intOnly('estimatedCostWithoutGST',this.value);">
	                        						</div>
	                        						<div class="col-xl-3 mb-3">
	                        							<label class="form-label" for="estimatedCostWithGST">Estimated Cost <span class="mb-0 text-muted fs-11">(With GST)</span>
	                        								<span class="text-red">*</span>
	                        							</label>
	                        							<input class="form-control" type="number" name="estimatedCostWithGST" id="estimatedCostWithGST" readonly value="<?php echo $contractdetails->estimated_cost_with_gst;?>" onblur="charlimit('estimatedCostWithGST', 12);" onkeyup="intOnly('estimatedCostWithGST',this.value);">
	                        						</div>
	                        					...
	                        					<div class="form-row">
	                        						<div class="col-xl-3 mb-3">
	                        							...
	                        							<input class="form-control" type="number" name="supplyOfGoods" id="supplyOfGoods" value="<?php echo $contractdetails->supply_of_goods;?>" readonly onblur="addcontractprice()" onkeyup="intOnly('supplyOfGoods',this.value);">
	                        						</div>
	                        						<div class="col-xl-3 mb-3">
	                        							<label class="form-label" for="installationServices">Installation and Other Services
	                        								<span class="text-red">*</span>
	                        							</label>
	                        							<input class="form-control" type="number" name="installationServices" id="installationServices" value="<?php echo $contractdetails->installation_other_services;?>" readonly onblur="addcontractprice()" onkeyup="intOnly('installationServices',this.value);">
	                        						</div>
	                        						<div class="col-xl-3 mb-3">
	                        							<label class="form-label" for="quotedPriceWithoutGST">Contract  Price<span class="mb-0 text-muted fs-11">(Without GST)</span>
	                        								<span class="text-red">*</span>
	                        							</label>
	                        							<input class="form-control" type="text" name="quotedPriceWithoutGST" id="quotedPriceWithoutGST" readonly value="<?php echo $contractdetails->quoted_price_without_gst;?>" readonly onblur="charlimit('quotedPriceWithoutGST', 12);" onkeyup="intOnly('quotedPriceWithoutGST',this.value);">
	                        						</div>
	                        					</div>
	                        					...
	                        					<div class="form-row">
	                        						<div class="col-xl-3 mb-3">
	                        							...
	                        							<input class="form-control" type="number" name="gst" id="gst"  value="<?php echo $contractdetails->GST;?>" readonly onblur="addcontractpricewithgst()" onkeyup="intOnly('gst',this.value);">
	                        						</div>
	                        						<div class="col-xl-3 mb-3">
	                        							<label class="form-label" for="quotedPriceWithGST">Contract  Price <span class="mb-0 text-muted fs-11">(With GST)</span>
	                        								<span class="text-red">*</span>
	                        							</label>
	                        							<input class="form-control" type="text" name="quotedPriceWithGST" id="quotedPriceWithGST" readonly value="<?php echo $contractdetails->quoted_price_with_gst;?>" readonly onblur="charlimit('quotedPriceWithGST', 12);" onkeyup="intOnly('quotedPriceWithGST',this.value);">
	                        						</div>
	                        					</div>
	                        					...
	                        					<div class="form-row">
	                        						...
	                        						<div class="col-xl-4">
	                        							...
	                        							<input class="form-control" type="text" name="quantity" id="quantity" value="<?php echo $contractdetails->quantity;?>" readonly onblur="charlimit('quantity', 7);" onkeyup="intOnly('quantity',this.value);">	
	                        						</div>
 ...
 -->
	                        							<div class="table-responsive" id="milestone_table">
	                        								<table class="table table-bordered border text-nowrap mb-0" id="new-edit-milestone">
																...
																<?php foreach($contractmilestonesdetails as $milestone) { ?>
	                        										<tr>
	                        											<td><?php echo $milestone['stage_text'];?></td>
	                        											<td><?php echo date('d-m-Y', strtotime($milestone['date']));?></td>
	                        											<td><?php echo $milestone['quantity'];?></td>
	 ...
	 <div class="table-responsive" id="region_table">
	                        								<table class="table table-bordered border text-nowrap mb-0" id="new-edit-region">
	                        									...
	                        									<tbody>
	                        										<?php $i=0; if(!empty($contractregionsdetails)) { ?>	
																<?php foreach($contractregionsdetails as $region) { ?>
	                        										<tr>
	                        											<td><?php echo $region['region_text'];?></td>
	                        											<td><?php echo $region['circle_text'];?></td>
	                        											<td><?php echo $region['division_text'];?></td>
	                        											<td><?php echo $region['location'];?></td>
	                        											<td><?php echo $region['feedername'];?></td>
	                        											<td><?php echo $region['feederid'];?></td>
	                        											<td><?php echo $region['geocode'];?></td>
	                        											<td><?php echo  $region['quantity'];?></td>
	                        											<?php if(isset($_SESSION['boq_worktype']) && $_SESSION['boq_worktype']==1) { ?>
	                        											<td>
	                        												<button id="bEdit" type="button" class="btn btn-sm btn-obs"  onclick="showmodal(<?php echo $i;?>)" ><span class="fe fe-more-vertical"> </span> </button>
	                        											</td>
	                        										<?php } ?>
	                        										</tr>
	                        									<?php $i++; } ?>	
