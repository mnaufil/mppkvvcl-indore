                            ...
                            <div class="row row-sm">
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form name="saveDivision" id="saveDivision" method="post" action="<?php echo base_url('save-division'); ?>">
                                                <div class="row">
                                                    <div class="col-xl-4 mb-3">
                                                        <label class="form-label" for="region">Region <span class="text-red">*</span></label>
                                                        <select class="form-control select2 select-hidden-accessible" id="region" name="region">
                                                    ...
                                                    <div class="col-xl-4 mb-3">
                                                        ...
                                                        <select class="form-control select2 select-hidden-accessible" id="circle" name="circle">
