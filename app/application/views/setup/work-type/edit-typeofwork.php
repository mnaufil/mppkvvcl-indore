...
<html lang="en" dir="ltr">
    ...
    <head>
        ...
        <!-- TITLE -->
        <title>MPPKVVCL - Edit Type Of Work</title>
                    ...
                    <div class="side-app">
                        ...
                        <div class="main-container container-fluid">
                            ...
                            <div class="page-header">
                                <h1 class="page-title">Edit Type of Work</h1>
                            </div>
                            <!-- PAGE-HEADER END -->
                                            ...
                                            <form class="needs-validation" novalidate method="post" action="<?php echo base_url('save-typeofwork'); ?>">
                                                <div class="form-row">
                                                    <div class="col-xl-4 mb-3">
                                                        <label for="validationCustom01" class="form-label">Work Name <span class="text-red">*</span></label>
                                                        <input type="text" class="form-control" id="validationCustom01"
                                                            value="33 KV / 11 KV New Substation (Nos)" required>
