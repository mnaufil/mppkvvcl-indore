$(document).ready(function() {
    ...
    var material_example1 = new BSTableMaterial("new-add-material-details", {
        $addButton: $("#table2-new-row-button-material-details"),
        onEdit:function() {
            console.log("EDITED");
        }
    });
    material_example1.init();

    var material_example2 = new BSTableMaterialReceived("new-edit-material-received-details", {
        $addButton: $("#table2-new-row-button-material-received-details"),
        onEdit:function() {
            console.log("EDITED");
        }
    });
    material_example2.init();

    var material_example3 = new BSTableMaterialRandomSampling("new-edit-material-sampling-details", {
        $addButton: $("#table2-new-row-button-material-sampling-details"),
        onEdit:function() {
            console.log("EDITED");
        }
    });
    material_example3.init();

    var material_example4 = new BSTableMaterial("new-edit-material-details", {
        // $addButton: $("#table2-new-row-button-material-sampling-details"),
        onEdit:function() {
            console.log("EDITED");
        }
    });
    material_example4.init();
